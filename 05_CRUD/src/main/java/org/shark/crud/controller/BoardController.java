...
@RequiredArgsConstructor  //-- Spring Container에 있는 BoardDAO 타입의 빈을
                          //   private final BoardService boardService에 자동 주입(@Autowired) 하기 위한 생성자
...
public class BoardController {
  ...
  public String write(HttpSession session
                      , RedirectAttributes redirectAttrs  //----- redirect시 사용하는 데이터 전달 컨테이너
    ...
    //      따라서, nickname에 해당되는 작성자의 uid를 DB로부터 가져와야 합니다.
    ...
    //      redirect 시 데이터 전달은 RedirectAttribute를 이용할 수 있습니다.
